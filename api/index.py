"""
Vercel serverless function - FastAPI fallback mode only.
Skipping backend import to avoid logger filesystem errors.
"""
...
# Create FastAPI app
app = FastAPI(title="Entrepedia AI Platform API (Vercel Mode)")
